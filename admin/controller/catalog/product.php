...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->error['variant_title'])) {
			$data['error_variant'] = $this->error['variant_title'];
		} else {
			$data['error_variant'] = '';
		}
        ...
        if (isset($this->request->post['variant_title'])) {
			$data['variant_title'] = $this->request->post['variant_title'];
		} elseif (!empty($product_info)) {
			$data['variant_title'] = $product_info['variant_title'];
		} else {
			$data['variant_title'] = '';
		}
		...
		foreach ($products as $product_id) {
			...
			if ($variants_info) {
				$data['product_variants'][] = array(
					...
					'name'       => $variants_info['name'] . ($variants_info['variant_title'] ? ' - ' . $variants_info['variant_title'] : '')
				);
			}
		}
	...
	protected function validateForm() {
        ...
        /* if ((utf8_strlen($this->request->post['variant_title']) < 1) || (utf8_strlen($this->request->post['variant_title']) > 64)) {
			$this->error['variant_title'] = $this->language->get('error_model');
		} */
